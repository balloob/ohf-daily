# OHF Daily voice and style

OHF Daily is a concise newspaper for people who care about the open-home ecosystem but do not spend their day reading pull requests. It is independent editorial coverage, not a changelog, project announcement channel, fan site, or marketing newsletter.
...
- Name the people behind roadmap work. Naturally credit who proposed, rewrote, shaped, reviewed, or approved an opportunity, using a verified public name and the role established by the source. Keep the reader outcome first; a name does not need to become the headline.
...
- Open with the consequence. A reader should understand who benefits and why the story matters before encountering implementation detail.
- Prefer two or three compact paragraphs. A brief may use one or two; a release lead may use three or four when the themes genuinely differ.
- Give each paragraph a job: outcome and context; how it works or what failed; evidence, limits, continuity, or human credit.
- Translate source language rather than polishing it. Never reproduce PR templates, raw descriptions, checklists, release-note fragments, or an author’s self-promotional framing.
- Define necessary jargon on first use. Keep exact numbers when they establish scale, performance, reliability, or risk, and preserve the measurement conditions.
- Use continuity only when it changes the reader’s understanding of today’s step. Do not narrate chronology for its own sake.
- Attribute claims whose authority belongs to an official post, independent publication, benchmark, or named contributor.
...
- No artificial balance between projects and no filler article to complete a layout, beat, or quota.
- No repeated conclusion disguised as a final paragraph.

The desired result feels like a sharp five-minute morning briefing: selective, useful, source-linked, and written by someone who understands both the technology and why a person might care.
