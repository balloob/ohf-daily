...
- newsletter breadth and foundation support: substantive donations must receive appropriate editorial weight, and each interesting newsletter section is assessed independently; a shared source URL alone never makes distinct stories duplicates. Verify new official posts appear in Just shipped with original links, without treating their contents as a software release;
