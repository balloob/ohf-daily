...
- complete roadmap accounting: compare eligible actual opportunity changes and fresh substantive source statements with the final article/source list. Every changed opportunity needs coverage, whether individually, grouped with related changes, or in a coherent batch. Missing coverage is a blocking finding; article quotas and recent coverage are not reasons to omit it. Baseline collection and transport-only timestamp changes do not require a backlog digest, and draft exclusions still apply;
